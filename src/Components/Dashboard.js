...
//             }}
//             className="bg-[#5DC3F9] w-[350px] flex justify-center gap-4 items-center h-[90px] rounded-lg shadow-lg mb-4 hover:cursor-pointer"
//           >
...
//             </div>
//           </div>
//           <div className="bg-[#D7BBEF]  w-[350px] gap-4 flex justify-center items-center h-[90px] rounded-lg shadow-lg mb-4 hover:cursor-pointer">
//             <div className="content-start">
//               <img src={tasklogo.src} alt="Logo" className="w-13 h-13" />
//             </div>
//             <div>
//               <p className="text-2xl text-[#813EBA] font-bold">Upcoming Task</p>
//             </div>
//           </div>
...
//             }}
//             className="bg-[#BFE3A0]  w-[350px] gap-4 flex justify-center items-center h-[90px] rounded-lg shadow-lg mb-4 hover:cursor-pointer"
//           >
//             <div className="content-start">
//               <img src={userapproval.src} alt="Logo" className="w-13 h-13" />
//             </div>
//             <div>
...
{isAdminOrSuperAdmin && (
            <div
              ...
              className="bg-[#f3ecb0] w-[350px] gap-4 flex justify-center items-center h-[90px] rounded-lg shadow-lg mb-4 hover:cursor-pointer"
            >
              <div className="content-start">
                <img src={texttospeech.src} alt="Logo" className="w-13 h-13 bg-transparent" />
              </div>
              <div>
